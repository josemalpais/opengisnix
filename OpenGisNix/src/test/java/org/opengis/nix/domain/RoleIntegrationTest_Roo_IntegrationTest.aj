...
privileged aspect RoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void RoleIntegrationTest.testCountRoles() {
        ...
        long count = org.opengis.nix.domain.Role.countRoles();
    ...
    public void RoleIntegrationTest.testFindRole() {
        org.opengis.nix.domain.Role obj = dod.getRandomRole();
        ...
        obj = org.opengis.nix.domain.Role.findRole(id);
    ...
    public void RoleIntegrationTest.testFindAllRoles() {
        ...
        java.util.List<org.opengis.nix.domain.Role> result = org.opengis.nix.domain.Role.findAllRoles();
    ...
    public void RoleIntegrationTest.testFindRoleEntries() {
        ...
        java.util.List<org.opengis.nix.domain.Role> result = org.opengis.nix.domain.Role.findRoleEntries(0, (int) count);
    ...
    public void RoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.opengis.nix.domain.Role merged =  obj.merge();
        obj.flush();
    ...
    public void RoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Role' failed to initialize correctly", dod.getRandomRole());
        org.opengis.nix.domain.Role obj = dod.getNewTransientRole(Integer.MAX_VALUE);
    ...
    public void RoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Role' with identifier '" + id + "'", org.opengis.nix.domain.Role.findRole(id));
    }
