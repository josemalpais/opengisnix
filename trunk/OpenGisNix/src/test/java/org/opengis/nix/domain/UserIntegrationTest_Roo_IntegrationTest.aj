...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserIntegrationTest.testCountUsers() {
        ...
        long count = org.opengis.nix.domain.User.countUsers();
    ...
    public void UserIntegrationTest.testFindUser() {
        org.opengis.nix.domain.User obj = dod.getRandomUser();
        ...
        obj = org.opengis.nix.domain.User.findUser(id);
    ...
    public void UserIntegrationTest.testFindAllUsers() {
        ...
        java.util.List<org.opengis.nix.domain.User> result = org.opengis.nix.domain.User.findAllUsers();
    ...
    public void UserIntegrationTest.testFindUserEntries() {
        ...
        java.util.List<org.opengis.nix.domain.User> result = org.opengis.nix.domain.User.findUserEntries(0, (int) count);
    ...
    public void UserIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUser(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.opengis.nix.domain.User merged =  obj.merge();
        obj.flush();
    ...
    public void UserIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'User' failed to initialize correctly", dod.getRandomUser());
        org.opengis.nix.domain.User obj = dod.getNewTransientUser(Integer.MAX_VALUE);
    ...
    public void UserIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'User' with identifier '" + id + "'", org.opengis.nix.domain.User.findUser(id));
    }
