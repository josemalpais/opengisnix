...
import org.opengis.nix.domain.UserRoleDataOnDemand;
...
privileged aspect UserRoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserRoleIntegrationTest.testCountUserRoles() {
        ...
        long count = org.opengis.nix.domain.UserRole.countUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRole() {
        org.opengis.nix.domain.UserRole obj = dod.getRandomUserRole();
        ...
        obj = org.opengis.nix.domain.UserRole.findUserRole(id);
    ...
    public void UserRoleIntegrationTest.testFindAllUserRoles() {
        ...
        java.util.List<org.opengis.nix.domain.UserRole> result = org.opengis.nix.domain.UserRole.findAllUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRoleEntries() {
        ...
        java.util.List<org.opengis.nix.domain.UserRole> result = org.opengis.nix.domain.UserRole.findUserRoleEntries(0, (int) count);
    ...
    public void UserRoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.opengis.nix.domain.UserRole merged =  obj.merge();
        obj.flush();
    ...
    public void UserRoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserRole' failed to initialize correctly", dod.getRandomUserRole());
        org.opengis.nix.domain.UserRole obj = dod.getNewTransientUserRole(Integer.MAX_VALUE);
    ...
    public void UserRoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserRole' with identifier '" + id + "'", org.opengis.nix.domain.UserRole.findUserRole(id));
    }
