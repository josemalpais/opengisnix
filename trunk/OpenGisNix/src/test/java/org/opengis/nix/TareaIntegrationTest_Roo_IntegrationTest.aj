...
privileged aspect TareaIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TareaIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TareaIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");
    
    declare @type: TareaIntegrationTest: @Transactional;
    
    @Autowired
    private TareaDataOnDemand TareaIntegrationTest.dod;
    
    @Test
    public void TareaIntegrationTest.testCountTareas() {
    ...
    @Test
    public void TareaIntegrationTest.testFindTarea() {
    ...
    @Test
    public void TareaIntegrationTest.testFindAllTareas() {
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", dod.getRandomTarea());
        long count = org.opengis.nix.Tarea.countTareas();
    ...
    @Test
    public void TareaIntegrationTest.testFindTareaEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", dod.getRandomTarea());
        long count = org.opengis.nix.Tarea.countTareas();
    ...
    @Test
    public void TareaIntegrationTest.testFlush() {
        org.opengis.nix.Tarea obj = dod.getRandomTarea();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to provide an identifier", id);
    ...
    @Test
    public void TareaIntegrationTest.testMerge() {
        org.opengis.nix.Tarea obj = dod.getRandomTarea();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to provide an identifier", id);
    ...
    @Test
    public void TareaIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", dod.getRandomTarea());
    ...
    @Test
    public void TareaIntegrationTest.testRemove() {
        org.opengis.nix.Tarea obj = dod.getRandomTarea();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Tarea' failed to provide an identifier", id);
